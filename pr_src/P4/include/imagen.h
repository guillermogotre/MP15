...
/**
@brief Extrae el plano k de una imagen
@param k indica el plano a extraer de la imagen
@retval Devuelve la imagen resultante de la extracción del plano k a la imagen
*/
   Imagen plano(int k);

/**
@brief Convierte una cadena a arte ASCII
@param grises cadena con los caracteres ASCII para la representación arte ASCII
@param arteASCII cadena resultado donde se escribirá la imagen convertida a arte ASCII
@retval maxlong longitud máxima permitida para la conversión
@retval true   si ha tenido éxito en la conversión
@retval false  si se ha producido algún error en la conversión
*/
